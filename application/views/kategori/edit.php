		...
		<div class="row mt">	
			...
			<div class="col-lg-8 col-lg-offset-2">
				...
				<form role="form">
				  ...
				  <textarea  type="text" name="cat_description" value="<?php echo set_value('cat_description', $category->cat_description) ?>"  class="form-control" rows="6" placeholder="Content"></textarea>
				  <br>
